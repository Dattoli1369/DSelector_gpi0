...
void runDSelector(){
  ...
  TString nameOfTree = "gpi0__M7_B4_Tree";
  ...
  string options = "";
  string outputHistFileName="gpi0_hists.root"; // name of the root file with the histograms
  string outputTreeFileName="gpi0_Tree.root"; // name of the root file with the tree

  //// Choice 1: run with proof with your desired number of threads /////
  DPROOFLiteManager::Process_Chain(chain, "DSelector_gpi0.C+",  proof_Nthreads, outputHistFileName, outputTreeFileName, options);
