#include "DSelector_gpi0.h"

void DSelector_gpi0::Init(TTree *locTree)
{
	...
	dOutputFileName = "gpi0.root"; //"" for none
	dOutputTreeFileName = ""; //"" for none
	dFlatTreeFileName = "gpi0_Tree.root"; //output flat tree (one combo per tree entry), "" for none
	...
	*/
	...
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_chiSq_ndf");
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_cl");

	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_mass3gamma");
	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_massg1g2");
	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_massg1g3");
	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_massg2g3");

	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_g1g2P"); // total momentun
	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_g1g3P");
	dFlatTreeInterface->Create_Branch_Fundamental<double>("l_g2g3P");
	
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g1TBCAL"); // BCAL timing
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g1FCAL"); // FCAL timing
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g2TBCAL");
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g2FCAL");
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g3TBCAL");
	dFlatTreeInterface->Create_Branch_Fundamental<double_t>("l_g3FCAL");
...
Bool_t DSelector_gpi0::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(const auto& loc_combo : loc_combos)
	{
		...
		locMissingP4_Measured -= locPhoton1P4_Measured + locProtonP4_Measured + locPhoton2P4_Measured + locPhoton3P4_Measured;
	...
	// ===================== FILL FLAT TREE HERE =====================
		...
		// chi2/ndf and CL
		double locChiSq = dComboWrapper->Get_ChiSq_KinFit("");
		double locNDF   = dComboWrapper->Get_NDF_KinFit("");
		double locCL    = dComboWrapper->Get_ConfidenceLevel_KinFit("");
		double locRFTime = dComboWrapper->Get_RFTime_Measured();
		double locPropagatedRFTimeg1 = locRFTime + (locPhoton1P4_Measured.Z() - dTargetCenter.Z()) / 29.9792458;
		double locg1DeltaT = locPhoton1P4_Measured.T() - locPropagatedRFTimeg1;
		double locPropagatedRFTimeg2 = locRFTime + (locPhoton2P4_Measured.Z() - dTargetCenter.Z()) / 29.9792458;
		double locg2DeltaT = locPhoton2P4_Measured.T() - locPropagatedRFTimeg2;
		double locPropagatedRFTimeg3 = locRFTime + (locPhoton3P4_Measured.Z() - dTargetCenter.Z()) / 29.9792458;
		double locg3DeltaT = locPhoton3P4_Measured.T() - locPropagatedRFTimeg3;

		dFlatTreeInterface->Fill_Fundamental<double_t>("l_chiSq_ndf", locChiSq/locNDF);
		dFlatTreeInterface->Fill_Fundamental<double_t>("l_cl", locCL);

		// invariant masses
		TLorentzVector g1 = locPhoton1P4_Measured;
		TLorentzVector g2 = locPhoton2P4_Measured;
		TLorentzVector g3 = locPhoton3P4_Measured;

		dFlatTreeInterface->Fill_Fundamental<double>("l_mass3gamma", (g1+g2+g3).M());
		dFlatTreeInterface->Fill_Fundamental<double>("l_massg1g2", (g1+g2).M());
		dFlatTreeInterface->Fill_Fundamental<double>("l_massg1g3", (g1+g3).M());
		dFlatTreeInterface->Fill_Fundamental<double>("l_massg2g3", (g2+g3).M());

		// momenta
		dFlatTreeInterface->Fill_Fundamental<double>("l_g1g2P", (g1+g2).P());
		dFlatTreeInterface->Fill_Fundamental<double>("l_g1g3P", (g1+g3).P());
		dFlatTreeInterface->Fill_Fundamental<double>("l_g2g3P", (g2+g3).P());

		// timing
		if (dPhoton1Wrapper->Get_Detector_System_Timing() == SYS_BCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g1TBCAL", locg1DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g1TBCAL", -999);
		}
		if (dPhoton1Wrapper->Get_Detector_System_Timing() == SYS_FCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g1FCAL", locg1DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g1FCAL", -999);
		}

		if (dPhoton2Wrapper->Get_Detector_System_Timing() == SYS_BCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g2TBCAL", locg2DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g2TBCAL", -999);
		}
		if (dPhoton2Wrapper->Get_Detector_System_Timing() == SYS_FCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g2FCAL", locg2DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g2FCAL", -999);
		}

		if (dPhoton3Wrapper->Get_Detector_System_Timing() == SYS_BCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g3TBCAL", locg3DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g3TBCAL", -999);
		}
		if (dPhoton3Wrapper->Get_Detector_System_Timing() == SYS_FCAL){
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g3FCAL", locg3DeltaT);
		}
		else {
			dFlatTreeInterface->Fill_Fundamental<double_t>("l_g3FCAL", -999);
		}
// ==============================================================
		//FILL FLAT TREE
...
void DSelector_gpi0::Finalize(void)
{
